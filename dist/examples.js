(function (factory) {
    ...
    */
    ...
    let LoadingSpinner = class LoadingSpinner extends LitElement {
        ...
        render() {
            ...
            <div
                class="${classMap({
            [modules_b42352cd.loadingIndicator]: true,
            [modules_b42352cd.centered]: this.centered,
        })}"
            >
    ...
    */
    ...
    class ExampleService {
        ...
        getCleanName(text) {
            return text
                .split('-')
                .map((part) => [...part].some(char => char !== char.toUpperCase()) ? part[0].toUpperCase() + part.substr(1) : part)
                .join(' ');
        }
    }
    __decorate([
        observable
    ], ExampleService.prototype, "examplesResponse", void 0);
    __decorate([
        observable
    ], ExampleService.prototype, "activeExample", void 0);
    __decorate([
        computed
    ...
    const globalDependencies = new DependencyContainer({
        urlService: (container, config) => new UrlService(config.urlConfig),
        requestService: (container, config) => new RequestService(config.requestOptions),
        exampleService: (container) => {
    ...
    let EditorPreview = class EditorPreview extends LitElement {
        ...
        onLoadIframe(event) {
            ...
            const iframeBody = (_b = (iframe.contentDocument || ((_a = iframe.contentWindow) === null || _a === void 0 ? void 0 : _a.document))) === null || _b === void 0 ? void 0 : _b.body;
            if (!iframeBody) {
    ...
    ***************************************************************************** */
    ...
    let EditorCode = class EditorCode extends MobxLitElement {
        ...
        updateEditorCode(from, to, insert) {
        ...
        triggerRefreshPreview() {
            ...
            const updateCodeEvent = new CustomEvent('update-code', {
                detail: {
